...
_Header ctrlSetPosition [0.805 * safezoneW + safezoneX, 0.01 * safezoneH + safezoneY, 0.185 * safezoneW, 0.011 * safezoneH];
_Header ctrlSetBackgroundColor _TitleColour;
...
_TextField ctrlSetPosition [0.805 * safezoneW + safezoneX, 0.021 * safezoneH + safezoneY, 0.185 * safezoneW, 0.5];
_TextField ctrlCommit 0;
_TextField ctrlSetPosition [0.805 * safezoneW + safezoneX, 0.021 * safezoneH + safezoneY, 0.185 * safezoneW, ((ctrlTextHeight _TextField)+ (0.005 * safezoneH))];

_TextField ctrlSetBackgroundColor [0.129,0.129,0.129, 0.9];
