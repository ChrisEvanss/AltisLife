...
switch (_code) do {
    ...
    case 209: {
        switch (player getVariable["Earplugs",100]) do {
			case 100: {["Ear Plugs 90%", "info", 1] call Aquaman_fnc_notification_system; 1 fadeSound 0.9; player setVariable ["Earplugs", 90]; };
			case 90: {["Ear Plugs 80%", "info", 1] call Aquaman_fnc_notification_system; 1 fadeSound 0.8; player setVariable ["Earplugs", 80]; };
			case 80: {["Ear Plugs 70%", "info", 1] call Aquaman_fnc_notification_system; 1 fadeSound 0.7; player setVariable ["Earplugs", 70]; };
			case 70: {["Ear Plugs 60%", "info", 1] call Aquaman_fnc_notification_system; 1 fadeSound 0.6; player setVariable ["Earplugs", 60]; };
            case 60: {["Ear Plugs 50%", "info", 1] call Aquaman_fnc_notification_system; 1 fadeSound 0.5; player setVariable ["Earplugs", 50]; };
            case 50: {["Ear Plugs 40%", "info", 1] call Aquaman_fnc_notification_system; 1 fadeSound 0.4; player setVariable ["Earplugs", 40]; };
            case 40: {["Ear Plugs 30%", "info", 1] call Aquaman_fnc_notification_system; 1 fadeSound 0.3; player setVariable ["Earplugs", 30]; };
            case 30: {["Ear Plugs 20%", "info", 1] call Aquaman_fnc_notification_system; 1 fadeSound 0.2; player setVariable ["Earplugs", 20]; };
            case 20: {["Ear Plugs 10%", "info"], 1 call Aquaman_fnc_notification_system; 1 fadeSound 0.1; player setVariable ["Earplugs", 10]; };
            case 10: {["Ear Plugs 0%", "info", 1] call Aquaman_fnc_notification_system; 1 fadeSound 0; player setVariable ["Earplugs", 0]; };
		    };
    };
    case 201: {
        switch (player getVariable["Earplugs", 0]) do {
			case 0: {["Ear Plugs 10%", "info", 1] call Aquaman_fnc_notification_system; 1 fadeSound 0.1; player setVariable ["Earplugs", 10]; };
			case 10: {["Ear Plugs 20%", "info", 1] call Aquaman_fnc_notification_system; 1 fadeSound 0.2; player setVariable ["Earplugs", 20]; };
			case 20: {["Ear Plugs 30%", "info", 1] call Aquaman_fnc_notification_system; 1 fadeSound 0.3; player setVariable ["Earplugs", 30]; };
			case 30: {["Ear Plugs 40%", "info", 1] call Aquaman_fnc_notification_system; 1 fadeSound 0.4; player setVariable ["Earplugs", 40]; };
            case 40: {["Ear Plugs 50%", "info", 1] call Aquaman_fnc_notification_system; 1 fadeSound 0.5; player setVariable ["Earplugs", 50]; };
            case 50: {["Ear Plugs 60%", "info", 1] call Aquaman_fnc_notification_system; 1 fadeSound 0.6; player setVariable ["Earplugs", 60]; };
            case 60: {["Ear Plugs 70%", "info", 1] call Aquaman_fnc_notification_system; 1 fadeSound 0.7; player setVariable ["Earplugs", 70]; };
            case 70: {["Ear Plugs 80%", "info", 1] call Aquaman_fnc_notification_system; 1 fadeSound 0.8; player setVariable ["Earplugs", 80]; };
            case 80: {["Ear Plugs 90%", "info", 1] call Aquaman_fnc_notification_system; 1 fadeSound 0.9; player setVariable ["Earplugs", 90]; };
            case 90: {["Ear Plugs 100%", "info", 1] call Aquaman_fnc_notification_system; 1 fadeSound 1.0; player setVariable ["Earplugs", 100]; };
		    };
    };
};
